...
interface StorageInterface
{
     ...
     * @param int|float $value The value of the counter.
     ...
     *
     * @param string $key The ID of the counter to store.
     * @param int|float $oldValue The old value of the counter.
     * @param int|float $newValue The new value of the counter.
     * @param integer $ttl The TTL value of this counter.
     * @return boolean
     */
